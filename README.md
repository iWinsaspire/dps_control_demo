...
//海豚豚镜像投屏库
implementation 'cn.dolphinstar:ctrlMirror:x.x.x'
```
...
```
### 镜像投屏
镜像功能 ANDROID SDK版要大于23  
镜像仅支持海豚星空投屏接收端SDK

启动镜像先检测是否有窗口上的权限，有直接投，否则授权后投。具体参考 demo 的 MirrorUIActivity
```java
// 与电视建立连接
...
//启动镜像
MYOUController.of(MirrorUIActivity.this).getDpsMirror().Start(MirrorCfg mirrorCfg);
